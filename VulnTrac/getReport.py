...
def getReport(filename: str, documents: list, degree: str) -> str:

    if degree == "developer":
        file_path = r"C:\Users\ray\Desktop\ciscn\ciscn\reports\Markdown\developer.md"
    elif degree == "beginner":
        file_path = r"C:\Users\ray\Desktop\ciscn\ciscn\reports\Markdown\beginner.md"
    elif degree == "reviewer":
        file_path = r"C:\Users\ray\Desktop\ciscn\ciscn\reports\Markdown\reviewer.md"
    else:
        # 模型处理
        file_path = modelProcess(documents, filename, degree)
    with open(file_path, "r", encoding="utf-8") as f:
        ...
        pdf_name = degree + "_" + filename + "_" + timestamp + ".pdf"
