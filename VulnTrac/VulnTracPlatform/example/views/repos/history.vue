  ...
  <el-card class="history-card">
    <template #header>
      <div class="card-header">
        <el-text tag="b" size="large" type="primary">仓库检测记录</el-text>
    ...
    <div class="filter-bar">
      ...
      <el-select v-model="sortOrder" placeholder="排序方式" class="sort-select">
        ...
        <el-option label="仓库名称" value="repoName"></el-option>
        <el-option label="状态" value="status"></el-option>
      </el-select>
      <el-input v-model="search" placeholder="仓库名称/仓库URL搜索" class="search-input" />
      ...
      <el-card shadow="always" class="record-el-card">
        <div class="record-header">
          <div class="record-info">
            <el-link :underline="false">{{ record.repoName || '无仓库名称' }}</el-link>
            <el-link :href="record.repoUrl" target="_blank" :underline="false">{{ record.repoUrl || '无仓库URL' }}</el-link>
        ...
        <div class="record-body">
          <div class="record-details">
            <el-text>监测时间: {{ new Date(record.detectionTime).toLocaleString() }}</el-text>
          </div>
...
const records = ref([
  {
    id: 1,
    repoName: '仓库A',
    repoUrl: 'https://example.com/repoA',
    detectionTime: '2023-06-01T10:00:00Z',
    highRiskDefects: 5,
  ...
  },
  {
    id: 2,
    repoName: '仓库B',
    repoUrl: 'https://example.com/repoB',
    detectionTime: '2023-06-02T11:00:00Z',
    highRiskDefects: 3,
    mediumRiskDefects: 7,
    lowRiskDefects: 8,
  ...
  },
  {
    id: 3,
    repoName: '仓库C',
    repoUrl: 'https://example.com/repoC',
    detectionTime: '2023-06-03T12:00:00Z',
    highRiskDefects: 6,
    mediumRiskDefects: 9,
    lowRiskDefects: 12,
...
const sortedRecords = computed(() => {
  ...
  } else if (sortOrder.value === 'repoName') {
...
const filteredRecords = computed(() => {
  ...
  if (search.value) {
    result = result.filter(record => record.repoName.includes(search.value) || record.repoUrl.includes(search.value))
  }
