from .codeSplitter import ASTSplitter
import voyageai
...
def multiFileProcess(file_path: str) -> list:
    ...
    # 文件过滤
    filtered_file_list = [
        file for file in file_list if any(file.endswith(i) for i in filtered_extensions)
    ]

    for file in filtered_file_list:
        file_type, _ = os.path.splitext(file)
